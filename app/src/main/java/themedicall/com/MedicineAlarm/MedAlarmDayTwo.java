...
public class MedAlarmDayTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_med_alarm_day_two, container, false);
        ...
        rl_expand_for_afternoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(getActivity(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        Log.e("TAG", selectedHour + ":" + selectedMinute);
                        if(selectedHour>=12 && selectedHour<18) { //setting range of time for aftermoon
        ...
        rl_expand_for_evening.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(getActivity(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        Log.e("TAG", selectedHour + ":" + selectedMinute);
                       if(selectedHour>=18 && selectedHour<21) { //setting range of time for evining
